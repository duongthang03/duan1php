                ...
                if (isset($_SESSION['username'])) {
                  ...
                  <form action="index.php?act=chitiettour" method="post">
                    <div class="comment-slot">
                      ...
                      <textarea name="noidung" style="width: 100%; outline: none" placeholder="Viết bình luận của bạn..."
                        id="" cols="30" rows="10"></textarea><br>
                      <input type="submit" name="binhluan" value="Bình luận"
                        style="width: 80px; height: 30px; background-color: rgb(230, 34, 77); color: white; border-radius: 5px; border: none;">
                    </div>
                  </form>
                  <?php
                } else {
                ...
                foreach ($list_binhluan as $binhluan) {
                  ...
                  <div class="comment-slot">
                    <div class="thumb">
                      ...
                      <lord-icon src="https://cdn.lordicon.com/hrjifpbq.json" trigger="click"
                    ...
                    <div class="text">
                      <header class="comment-head">
                        <div class="left">
                          ...
                          <div class="meta">
                            <?= date("d-m-Y", strtotime($ngaybinhluan)) ?>
                          </div>
                        </div>
                      </header>
                      <div class="des">
          ...
          <div class="row db-3-col">
            ...
            foreach ($list_tour as $key => $value) {
              ...
              <article class="col-sm-6 col-md-4 article has-hover-s3">
                ...
                <h3 style="color: red;"><a style="color: red; font-weight: bold" href="#">Vé
                    <?= $tenkhuvuichoi ?> //
                    <?= $tendiadiem ?>
                  </a></h3>
                <h3 class="mota" style=""><a class="mota" href="#">
                    <?= $motaN ?>
                  </a></h3>
              </article>
              <?php
