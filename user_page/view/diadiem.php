                ...
                <div id="content" class="col-md-8 col-lg-9">
                            ...
                            <div class="select-holder">
                                ...
                                <script>
                                    ...
                                    price_href.addEventListener('change', function () {
                                        window.location.href = `index.php?act=diadiem&diadiem=<?= $_GET['diadiem'] ?>&page=${price_href.value}`;
                                    })
                                </script>
                            </div>
                        </div>
                    ...
                    <div class="content-holder content-sub-holder">
                        <div class="row db-3-col">
                            ...
                            <?php
                            $i = 0;
                            foreach ($list_tour_theodiadiem as $key => $value) {
                                extract($value);
                                $hinh = $img_path . $img;
                    ...
                    <nav class="pagination-wrap">
                        ...
                        <ul class='pagination'>
                            ...
                            for ($i = 1; $i <= $total_pages; $i++) {
                                $diadiem = "diadiem=" . $_GET['diadiem'] . "&" ?? "";
                                ?>
                                <li><a href="index.php?act=diadiem&<?= $diadiem ?>page=<?= $i ?>">
                                        <?= $i ?>
                                    </a></li>
                                <?php
                            }
